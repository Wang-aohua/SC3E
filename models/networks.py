...
def define_N(input_nc, output_nc, ngf, norm='batch', use_dropout=False, init_type='normal',
...
class PatchSampleF(nn.Module):
    ...
    def create_mlp(self, feats):
        for mlp_id, feat in enumerate(feats):
            ...
            mlp = nn.Sequential(*[nn.Linear(input_nc, self.nc), nn.BatchNorm1d(self.nc), nn.ReLU(), nn.Linear(self.nc, self.nc)])
    ...
    def forward(self, feats, num_patches=64, patch_ids=None,use_mlp=None):
        if use_mlp==None:
